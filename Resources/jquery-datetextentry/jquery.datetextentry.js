...
(function($){
    ...
    $.fn.datetextentry.defaults = {
        ...
        E_DAY_NAN             : 'El día debe ser número',
        E_DAY_TOO_BIG         : 'El día debe ser de 1 a 31',
        E_DAY_TOO_SMALL       : 'El día debe ser de 1 a 31',
        E_BAD_DAY_FOR_MONTH   : 'Only %d days in %m %y',
        E_MONTH_NAN           : 'EL Mes debe ser número',
        E_MONTH_TOO_BIG       : 'El Mes debe ser de 1 a 12',
        E_MONTH_TOO_SMALL     : 'El Mes debe ser de 1 a 12',
        E_YEAR_NAN            : 'EL Año debe ser número',
        E_YEAR_LENGTH         : 'El Año debe ser de 4 dígitos',
        E_YEAR_TOO_SMALL      : 'El año no puede ser anterior a %y',
        E_YEAR_TOO_BIG        : 'El año no puede ser posterior a %y',
        E_MIN_DATE            : 'La fecha no puede ser menor a %DATE',
        E_MAX_DATE            : 'La fecha no puede ser mayor a %DATE',
        month_name            : [
